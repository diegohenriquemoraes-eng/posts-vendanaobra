...
def gerar_capa(titulo: str, etiqueta: str, foto_path: str, destino: str) -> str:
    ...
    _espacado(d, (MARGEM, y_titulo - 58), etiqueta.upper(), fe, DOURADO, tracking=fe.size * 0.10)
